...
- **<!--fact:stdlib_modules-->67<!--/fact--> standard library modules** (`stdlib/*.tki`) with C runtime backing — strings,
...
toke ships <!--fact:stdlib_modules-->67<!--/fact--> standard library modules (`stdlib/*.tki`) backed by C runtime
