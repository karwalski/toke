# std.crypto — Extended Hashing and HMAC
...
f=verify_request(key:@byte;body:@byte;received_sig:@byte):bool{
  let expected=crypto.hmacsha256(key;body);
  <crypto.constanteq(expected;received_sig)
};

f=sign_payload(key:@byte;payload:@byte):@byte{
