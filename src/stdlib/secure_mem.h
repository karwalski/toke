...
/*
 * secure_mem.h — C interface for the std.secure_mem standard library module.
 *
...
/*
 * TkSecureBuf — lightweight handle returned by secure_mem.alloc().
 *
...
/*
 * Optional-string result for secure_mem.read().
...
/* -------------------------------------------------------------------------
 * secure_mem.alloc(size_bytes:i32; ttl_seconds:i32) -> SecureBuf
 *
...
/* -------------------------------------------------------------------------
 * secure_mem.write(buf:SecureBuf; data:str) -> bool
 *
...
/* -------------------------------------------------------------------------
 * secure_mem.read(buf:SecureBuf) -> ?(str)
 *
...
/* -------------------------------------------------------------------------
 * secure_mem.wipe(buf:SecureBuf) -> bool
 *
