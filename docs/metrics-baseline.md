...
| `conformance_cases_yaml` | **223** | `find test -name '*.yaml' \| wc -l` (grammar 98, diagnostics 90, lexical 35) |
| `conformance_cases_shell` | **8** | `ls test/conform/*.sh \| wc -l` |
| `conformance_cases_total` | **231** | the two rows above; `make conform` runs both |
