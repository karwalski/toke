...
| find | `arr.find(a;2)` | ok | E9003 | – | no | ABSENT module-style | - **WITHDRAWN 136.47**
| indexof | `a.indexof(1)` | ok | ok | SIGSEGV | no | **NEW** CRASH: routed to `tk_str_indexof_w` |
| indexof | `arr.indexof(a;1)` | ok | E9003 | – | no | ABSENT module-style | - **WITHDRAWN 136.47**
| contains | `a.contains(2)` | ok | ok | SIGSEGV | no | **NEW** CRASH: routed to `tk_str_contains_w` |
| contains | `arr.contains(a;2)` | ok | E9003 | – | no | ABSENT module-style | - **WITHDRAWN 136.47**
| slice | `a.slice(1;3)` | ok | ok | SIGSEGV | no | **NEW** CRASH: routed to `tk_str_slice_w` |
| slice | `arr.slice(a;1;3)` | ok | E9003 | – | no | ABSENT module-style | - **WITHDRAWN 136.47**
