...
| 124.2 | **Wave A:** ADR-0012 guards + bounds-check codegen | planned | **P0** | After 124.0. Division guards RT004 (`llvm.c:2756,2768`), nil-deref trap RT005 (`llvm.c:3618`), real stack canary (`sspstrong`, `llvm.c:7014`), documented narrow-int wrap; implement bounds-check codegen RT003 on load+store of `NODE_INDEX_EXPR` (`llvm.c:3878-3904`), converging `.set`/`$vec` semantics. Differential-tested. (Flip to default-on is 124.6.) Folds 123.4/121.31/121.36/122.3. |
