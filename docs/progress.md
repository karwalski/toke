...
| 124.4-fu | Follow-up: record grants in `.tkc.md` companion | planned | P1 | Extend `src/companion.c` to record a program's required grants, hash-bound to source — "what can this binary touch" as a verifiable audit fact. (Split from 124.4b; audit doc, non-functional.) |
