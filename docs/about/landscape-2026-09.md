...
Toke's design is not free of cost, either. Here is the canonical form the terseness argument rests on — compact, one way to write it, LL(1), and checkable by the compiler before it is ever run:
